# Generated by Django 3.0.7 on 2020-10-30 18:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('available', models.BooleanField(default=True)),
                ('camion', models.ManyToManyField(blank=True, related_name='camion', to='api.Camion')),
        ...
        migrations.AddField(
            ...
            name='proyecto',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='api.Proyecto'),
        ),
        migrations.AddConstraint(
            model_name='conductor',
            constraint=models.UniqueConstraint(fields=('subcontratista', 'camion'), name='Cndctr_subcontratista_camion'),
        ),
        migrations.AddConstraint(
            model_name='camion',
        ...
        migrations.AddField(
            ...
            name='proyecto',
            field=models.ManyToManyField(blank=True, related_name='proyecto', to='api.Proyecto'),
        ),
        migrations.AddConstraint(
            model_name='despachador',
            constraint=models.UniqueConstraint(fields=('proyecto', 'rut'), name='Dspchdr_proyecto_rut'),
        ),
        migrations.AddConstraint(
            model_name='administrador',
            constraint=models.UniqueConstraint(fields=('email',), name='Admnstrdr_rut'),
        ),
    ]
